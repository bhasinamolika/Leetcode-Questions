class Solution {
    public boolean canConstruct(String ransomNote, String magazine) {
        ...
        for(int i =0;i<ransomNote.length();i++)
        {
            ...
            // Inoder to ransomNote be substring of magazine ,the frequecy count of 
			//each character of ransomNote  in magazine should be either
			//greater than or equal to the frequecy count of each character of ransomNote 
			//otherwise ransomNote is not substring of magazine
